...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Naomi Kyla Zahra Siregar"; // ganti dengan nama kamu
  final String npm = "2406434102"; // ganti dengan NPM kamu
  final String kelas = "PBP B"; // ganti dengan kelas kamu
              ...
              child: Column(
                children: [
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di GoollMart — Football Shop',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
